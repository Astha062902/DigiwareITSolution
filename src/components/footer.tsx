...
//           <Image src="/assets/logobg.png" width={350} height={120} alt="Company Logo" className="company-logo" />
...
//           <h5>Our Services</h5>
//           <p><Image src="/assets/arrowhead.png" width={8} height={8} alt="mail"/>Web Development Services</p>
//           <p><Image src="/assets/arrowhead.png" width={8} height={8} alt="mail"/>Digital Marketing Services</p>
//           <p><Image src="/assets/arrowhead.png" width={8} height={8} alt="mail"/>Restaurant Digital Marketing</p>
//         </div>
//         <div className="footer-column">
//           <h5>Connect With Us</h5>
//           <p>Connect with us through our social media handles and channels</p>
//           <div className="social-icons">
//           <Image src="/assets/facebook.png" width={15} height={15} alt="mail"/>
//           <Image src="/assets/insta.png" width={15} height={15} alt="mail"/>
//           </div>
//         </div>
